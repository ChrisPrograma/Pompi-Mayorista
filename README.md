...
286 kB, para subir a cualquier hosting estático. Detalle en
...
src/ui/
  ...
  App.tsx                Shell, navegación, hojas y acciones.
...
5. Publicar en Vercel o Netlify y que el cliente la instale desde el navegador del celular.
