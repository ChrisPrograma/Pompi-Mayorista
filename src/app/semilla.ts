 ...
 * Datos de ejemplo.
 *
 * Sirven para dos cosas: que la app abra mostrando algo (una pantalla vacía no
 * enseña nada) y que los tests trabajen sobre un escenario realista del rubro.
 *
 * Se construyen como el sistema real los construiría: compras que generan stock
 * y costo, precios con vigencia, ventas con costo congelado. No hay ni un campo
 * de stock ni de precio asignado a mano.
 */
...
export { NEG as NEGOCIO_DEMO, LISTA as LISTA_DEMO, CATALOGO as CATALOGO_DEMO, entrarMercaderia };
